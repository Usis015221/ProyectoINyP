...
<script src="js/push.min.js"></script>
            <script>
             function push(){
                ...
                body: 'Los datos del estudiante han sido eliminados exitosamente',
                icon: "img/ds.jpg",
                timeout: 1500000,              
                vibrate: [100, 100, 100],    
                onClick: function() {
...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    ...
    <div class="container">
        ...
        <div class="container">
            ...
            <a href="NuevoEstudiante.php" class="btn btn-dark">Agregar Estudiante</a>
            <hr>
            <table class="table">
                <thead>
                    <tr>
                    ...
                    while ($Fila = $resultado->fetch_assoc()) { ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="EliminarEstudiante.php?Id=<?php echo $Fila["id"]?>" class="btn btn-danger" onclick="push();">Eliminar</a>
                            </td>
                        </tr>
                </tbody>
            <?php } ?>
