...
let arrayPalabras = ["PERRO", "GATO", "GALLINA", "VACA", "CONEJO", "PATO"];
//Arreglo que contiene las ayudas de cada palabra
let ayudas = [
        "Se dice que es el mejor amigo del hombre",
        "Animal que le gustan los ratones",
        "Animal que cacarea",
        "Es un animal que nos proporciona leche",
        "Animal que come zanahorias",
        "Animal que hace CUA CUA"
    ]
...
function cargarNuevaPalabra() {
    ...
    if (cantPalabrasJugadas > 6) {
        ...
        arrayPalabras = ["PERRO", "GATO", "GALLINA", "VACA", "CONEJO", "PATO"];
        ayudas = ["Se dice que es el mejor amigo del hombre",
            "Animal que le gustan los ratones",
            "Animal que cacarea",
            "Es un animal que nos proporciona leche",
            "Animal que come zanahorias",
