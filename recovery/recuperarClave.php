    ...
    <tr>
        <td style="background-color: #ffffff;">
            <div class="misection">
                ...
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <a href="localhost/Como-recuperar-clave-de-usuario-usando-PHP-y-MYSQL-master/" class="btnlink">Iniciar Sesión </a>
                <p>&nbsp;</p>
                 <p>&nbsp;</p>
                <img style="padding: 0;" src="localhost/Como-recuperar-clave-de-usuario-usando-PHP-y-MYSQL-master/assets/images/welltow.gif" width="50%">
                <p>&nbsp;</p>
            </div>
        </td>
    </tr>
