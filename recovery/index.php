...
<html lang="es">
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    ...
    <style type="text/css">
    .backgroundFondo{
    background: url('assets/images/img1.jpg') no-repeat center top;
    ...
    <div class="form">
        <div id="recuperarclave">
            ...
            <form action="recuperarClave.php" method="post">
                ...
                <input type="submit" class="button button-block miBtn mt-5" value="RECUPERAR CONTRASEÑA"/>
                <p>
                <a href="../login.php" id="volver" title="Volver">Volver</a>
        ...
        <div id="recuperarclave">
            <h1 class="text-center mb-5 recuperarPass">
                ¿Olvidaste tu contraseña? Solicita un cambio ahora mismo!!!
            </h1>


            <form action="recuperarClave.php" method="post">
                <div class="field-wrap">
                    <label>Escribe el Correo con el que estas registrado</label>
                    <input type="email" name="email" required autocomplete="off"/>
                </div>
