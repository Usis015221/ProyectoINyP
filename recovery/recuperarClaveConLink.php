...
$linkRecuperar      = "localhost/Como-recuperar-clave-de-usuario-usando-PHP-y-MYSQL-master/nuevaClave.php?id=".$dataConsulta['id']."&tokenUser=".$miTokenClave;

$destinatario = $correo; 
$asunto       = "Recuperando Clave - Aprendiendo Juntos";
$cuerpo = '
    <!DOCTYPE html>
    <html lang="es">
    <head>
...
<body>
    ...
    <img class="imgBanner" src="localhost/Como-recuperar-clave-de-usuario-usando-PHP-y-MYSQL-master/assets/images/banner2.png">
        <p>&nbsp;</p>
        <p>&nbsp;</p>
    <table style="max-width: 600px; padding: 10px; margin:0 auto; border-collapse: collapse;">
    <tr>
        <td style="padding: 0">
            <img style="padding: 0; display: block" src="localhost/Como-recuperar-clave-de-usuario-usando-PHP-y-MYSQL-master/assets/images/banner.jpg" width="100%">
        </td>
    </tr>
    ...
    <tr>
        <td style="background-color: #ffffff;">
            <div class="misection">
                ...
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <img style="padding: 0; display: block" src="localhost/Como-recuperar-clave-de-usuario-usando-PHP-y-MYSQL-master/assets/images/work.gif" width="100%">
                <p>&nbsp;</p>
            </div>
        </td>
    </tr>
    <tr>
        ...
        <div class="misection">
            ...
            <img style="padding: 0; display: block" src="localhost/Como-recuperar-clave-de-usuario-usando-PHP-y-MYSQL-master/assets/images/canal.png" width="100%">
        </div>
    ...
    <tr>
        <td style="padding: 0;">
            <img style="padding: 0; display: block" src="localhost/Como-recuperar-clave-de-usuario-usando-PHP-y-MYSQL-master/assets/images/footer.png" width="100%">
        </td>
    </tr>
</table>'; 
...
$cuerpo .= '
    ...
    $headers .= "From: guerra0904@hotmail.com \r\n"; 
    $headers .= "Reply-To: "; 
    $headers .= "Return-path:"; 
    $headers .= "Cc:"; 
    $headers .= "Bcc:"; 
